...
public class DepoCSingleton extends Depo {
	...
	public DepoCSingleton(getProduct product, getProduct producta, getProduct productb) {
		...
		// Filling the Native Product at the start
	...
	/**
	 * @method getInstance
	 * @return instance:DepoCSingleton
	...
	public static DepoCSingleton getInstance() {
        ...
        if (instance == null) {
            instance = new DepoCSingleton(Product.getProduct.INK, Product.getProduct.PAPER, Product.getProduct.BOOK);
        }
        return instance;
    }
}
